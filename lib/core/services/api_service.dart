...
class ApiService {
  ...
  // ── Auth options ─────────────────────────────────────────────
  static Future<Options> _authOpts({String contentType = 'application/json'}) async {
  ...
  static Future<void> logout() async {
    try {
      await _dio.post('/api/v1/sync/logout',
  ...
  /// Returns matched business (and bumps server search_count) or null.
